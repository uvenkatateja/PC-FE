...
import findPetAnimation from '../../assets/findpet.json';

const FindPetAnimation = ({ width = 300, height = 300, position = 'right' }) => {
  ...
  return (
    <div style={getPositionStyles()}>
      <Lottie 
        animationData={findPetAnimation} 
        loop={true}
...
export default FindPetAnimation;
